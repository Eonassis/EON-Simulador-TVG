...
LINK_POINTS = [[6,9,TIME_CASC_INI],
			   [9,11,TIME_CASC_INI+TIME_CASC],
			   [7,9,TIME_CASC_INI+(TIME_CASC*2)],
			   [9,12,TIME_CASC_INI+(TIME_CASC*2)],
			   [9,10,TIME_CASC_INI+(TIME_CASC*3)],
			   [6,7,TIME_CASC_INI+(TIME_CASC*3)],
			   [11,12,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[9,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
