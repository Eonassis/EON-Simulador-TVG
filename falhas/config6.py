...
LINK_POINTS = [[3,7,TIME_CASC_INI], 
			   [3,4,TIME_CASC_INI+(TIME_CASC)],
			   [4,7,TIME_CASC_INI+(TIME_CASC)],
			   [5,4,TIME_CASC_INI+(TIME_CASC*2)],
			   [5,3,TIME_CASC_INI+(TIME_CASC*2)],
			   [2,3,TIME_CASC_INI+(TIME_CASC*3)],
			   [7,6,TIME_CASC_INI+(TIME_CASC*3)],
			   [7,8,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[4,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
