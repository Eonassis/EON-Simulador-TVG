...
LINK_POINTS = [[2,6,TIME_CASC_INI], 
			   [1,2,TIME_CASC_INI+(TIME_CASC)],
			   [2,3,TIME_CASC_INI+(TIME_CASC)],
			   [6,1,TIME_CASC_INI+(TIME_CASC*2)],
			   [6,7,TIME_CASC_INI+(TIME_CASC*2)],
			   [3,7,TIME_CASC_INI+(TIME_CASC*3)],
