...
LINK_POINTS = [[13,17,TIME_CASC_INI], 
			   [13,12,TIME_CASC_INI+(TIME_CASC)],
			   [17,18,TIME_CASC_INI+(TIME_CASC)],
			   [13,10,TIME_CASC_INI+(TIME_CASC*2)],
			   [13,14,TIME_CASC_INI+(TIME_CASC*2)],
			   [17,23,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[13,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
