...
LINK_POINTS = [[16,21,TIME_CASC_INI],
			   [16,22,TIME_CASC_INI],
			   [16,17,TIME_CASC_INI+(TIME_CASC)],
			   [12,16,TIME_CASC_INI+(TIME_CASC*2)],
			   [16,15,TIME_CASC_INI+(TIME_CASC*2)],
			   [21,22,TIME_CASC_INI+(TIME_CASC*2)],
			   [21,20,TIME_CASC_INI+(TIME_CASC*3)],
			   [22,23,TIME_CASC_INI+(TIME_CASC*3)],
			   [22,17,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[16,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
