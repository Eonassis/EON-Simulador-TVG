...
LINK_POINTS = [[11,12,TIME_CASC_INI], 
			   [12,9,TIME_CASC_INI+(TIME_CASC)],
			   [12,16,TIME_CASC_INI+(TIME_CASC)],
			   [9,11,TIME_CASC_INI+(TIME_CASC*2)],
			   [11,13,TIME_CASC_INI+(TIME_CASC*2)],
			   [9,10,TIME_CASC_INI+(TIME_CASC*3)],
			   [11,15,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[2,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
