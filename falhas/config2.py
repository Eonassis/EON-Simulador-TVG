...
LINK_POINTS = [[11,19,TIME_CASC_INI],
			   [11,15,TIME_CASC_INI],
			   [11,12,TIME_CASC_INI+TIME_CASC], 
			   [11,9,TIME_CASC_INI+(TIME_CASC*2)],
			   [11,6,TIME_CASC_INI+(TIME_CASC*2)],
			   [15,16,TIME_CASC_INI+(TIME_CASC*3)],
			   [12,16,TIME_CASC_INI+(TIME_CASC*3)],
			   [9,12,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[11,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
