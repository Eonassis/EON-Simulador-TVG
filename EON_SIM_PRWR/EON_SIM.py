...
def Reroteamento(count, path, spectro, holding_time, src, dst, bandwidth, class_type):
	global topology, req_accepts, ativo, total_req_restauradas, bloqueio_rerroteamento_pr, restauradasF, afetadasF
...
def Quem_falhou_link(pontaa, pontab):
	...
	entradas_filtradas = sorted(entradas_filtradas, key=lambda x: x[1])
	print("entradas_filtradas2" , entradas_filtradas)
	#input()
