...
LINK_POINTS = [[18,17,TIME_CASC_INI],
			   [18,14,TIME_CASC_INI],
			   [13,17,TIME_CASC_INI+TIME_CASC],
			   [23,24,TIME_CASC_INI+TIME_CASC],
			   [17,23,TIME_CASC_INI+(TIME_CASC*2)],
			   [17,22,TIME_CASC_INI+(TIME_CASC*2)],
			   [17,16,TIME_CASC_INI+(TIME_CASC*3)],
			   [18,24,TIME_CASC_INI+(TIME_CASC*3)],
			   [14,13,TIME_CASC_INI+(TIME_CASC*3)]]

#pontos de falha = no, tempo [[4,2], [2,5]]
NODE_POINTS = [[18,TIME_CASC_INI+(TIME_CASC*3)+0.1]]
